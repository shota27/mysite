            ...
            <Flex justifyContent={"center"} alignItems={"center"} h="100%">
              <Box mr="140px" w="520px">
                ...
                >
                  <p>・総合政策学部一年</p>
                  <p>・AI班に所属したいです</p>
                  <p>・音楽生成AIなどに興味があります</p>
                  <p>プログラミングはほぼやったことないですが、よろしくお願いします。</p>

                </Text>
              </Box>
              <Image
                src="https://images.unsplash.com/photo-1652305730472-bbb7b8fd2e19?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDU3fDZzTVZqVExTa2VRfHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=900&q=60"
                width={"600px"}
              />
            </Flex>
            <ScrollAnimation />
